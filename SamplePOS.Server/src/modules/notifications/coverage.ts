...
export const NOTIFICATION_COVERAGE: readonly CoverageRow[] = [
  ...
  { area: 'Purchasing', operation: 'PO created', typeKey: 'PO_CREATED', status: 'PUBLISHED', preference: 'OPTIONAL', volume: 'high', reason: 'Draft/create is activity log; off by default', publisher: 'purchaseOrderService.createPO' },
  ...
  { area: 'Purchasing', operation: 'PO sent to supplier', typeKey: 'PO_SENT', status: 'PUBLISHED', preference: 'OPTIONAL', volume: 'high', reason: 'Send confirmation is activity log; off by default', publisher: 'purchaseOrderService.sendPOToSupplier' },
  ...
  { area: 'Purchasing', operation: 'Goods receipt finalized', typeKey: 'GOODS_RECEIVED', status: 'PUBLISHED', preference: 'OPTIONAL', volume: 'high', reason: 'Every GR is activity log; off by default', publisher: 'goodsReceiptService.finalizeGR' },
  ...
  { area: 'Inventory', operation: 'Stock transfer approved', typeKey: 'STOCK_TRANSFER_APPROVED', status: 'PUBLISHED', preference: 'OPTIONAL', volume: 'high', reason: 'Mid-workflow confirmation; off by default', publisher: 'storeTransferService.approveTransfer' },
  { area: 'Inventory', operation: 'Stock transfer received/completed', typeKey: 'STOCK_TRANSFER_COMPLETED', status: 'PUBLISHED', preference: 'OPTIONAL', volume: 'high', reason: 'Receive confirmation is activity log; off by default', publisher: 'storeTransferService.receiveTransfer' },
  ...
  { area: 'Expenses', operation: 'Expense approved', typeKey: 'APPROVAL_COMPLETED', status: 'PUBLISHED', preference: 'OPTIONAL', volume: 'high', reason: 'Approver already acted; off by default', publisher: 'expenseService.approveExpense' },
  ...
  { area: 'Expenses', operation: 'Expense paid', typeKey: 'EXPENSE_PAID', status: 'PUBLISHED', preference: 'OPTIONAL', volume: 'normal', reason: 'Paid confirmation; accountant/admin can opt into role default', publisher: 'expenseService.markExpensePaid' },

...
> = {
  ...
  ACTIVITY: {
    label: 'Activity log',
    description: 'Routine documents. Floor roles stay quiet. Supervisors get completed sales on their phones.',
    sort: 3,
  },
  SECURITY: {
    label: 'Security',
...
export const NOTIFICATION_CATALOG: readonly NotificationTypeDefinition[] = [
  def({
    ...
    description: 'Shows which products were sold, by whom, and for how much. Cashiers are not notified.',
    severity: 'INFO',
    ...
    highVolume: true,
    preferenceMode: 'ROLE_DEFAULT',
    roleDefaults: { CASHIER: OFF, STAFF: OFF, ACCOUNTANT: OFF },
  ...
  def({
    ...
    category: 'SALES',
    label: 'Returned sale',
    description: 'Shows which products were returned and the amount.',
    severity: 'WARNING',
    requiredPermission: 'sales.read',
    audience: 'permission_holders',
    defaultInApp: true,
  ...
  def({
    ...
    description: 'Shows customer name, receipt number and amount.',
    severity: 'INFO',
  ...
  def({
    ...
    description: 'Shows supplier name, payment number and amount.',
    severity: 'INFO',
    requiredPermission: 'purchasing.read',
    audience: 'permission_holders',
    defaultInApp: true,
  ...
  def({
    ...
    description: 'Shows expense title, number and amount waiting for approval.',
    severity: 'WARNING',
  ...
  def({
    ...
    description: 'Shows expense title, number and amount that was approved.',
    severity: 'INFO',
  ...
  def({
    ...
    description: 'Shows expense title, number and amount that was rejected.',
    severity: 'WARNING',
    requiredPermission: 'expenses.read',
    audience: 'permission_holders',
    defaultInApp: true,
  ...
  def({
    ...
    category: 'APPROVALS',
    label: 'Expense paid',
    description: 'Shows expense title, number and amount paid.',
    severity: 'INFO',
    requiredPermission: 'expenses.read',
    audience: 'permission_holders',
    defaultInApp: false,

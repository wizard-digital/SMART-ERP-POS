...
export const NOTIFICATION_CATALOG: readonly NotificationTypeDefinition[] = [
  def({
    ...
    description: 'A cashier completed a sale. Directors and managers are notified on their phones. The cashier is not notified and does not need to change settings.',
    severity: 'INFO',
